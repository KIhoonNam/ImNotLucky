...
public class GoblinBoss : Enemy
{
    ...
    void Netuarl()
    {
        ...
        Effect("Attack03", transform.GetChild(1).gameObject, 0.5f);
    ...
    void PlayerTakeDamage()
    {
        ...
        else
        {
            ...
            if (anim.GetBool("IsCombo"))
            {
                ...
                Effect("Idle02", transform.GetChild(1).gameObject, 0.5f);
            }
    ...
    public void IconState()
    {
        ...
        else if (Stats.Rand == 2 && Stats.Skill == 0)
        {
    ...
    void Victory()
    {
        ...
        Stats.Cool = 5;
        Stats.Skill = 3;
        Effect("Skill02_Start", transform.GetChild(1).gameObject, 0.5f);
    ...
    void OnDamage()
    {
        Effect("Damage", this.transform.GetChild(1).gameObject, 0.5f);
        PlayerSound();
        player.Sound.Play();
